...
/**
 * Input stream which takes in a stream providing MPEG TS data and outputs a
 * single track from it specified by the
...
public class MpegTsElementaryInputStream extends InputStream {
    ...
    private boolean isContinuable() {
        return !streamEndReached
                || programMapIdentifier != PID_NOT_PRESENT && elementaryStreamIdentifier != PID_NOT_PRESENT;
    }
